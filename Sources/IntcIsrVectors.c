...
extern void SwIrq4ISR(void);    //    2 
extern void PIT1inter(void);    //    1
extern void UART0iner(void);    //    3
...
#pragma section data_type ".intc_sw_isr_vector_table" ".intc_sw_isr_vector_table" data_mode=far_abs  
 ...
 (uint32_t)&PIT1inter, (uint32_t)&dummy, (uint32_t)&dummy, (uint32_t)&dummy, (uint32_t)&dummy, /* ISRs 60 - 64 */ 
 ...
 (uint32_t)&dummy, (uint32_t)&dummy, (uint32_t)&dummy, (uint32_t)&dummy, (uint32_t)&UART0iner, /* ISRs 75 - 79 */
