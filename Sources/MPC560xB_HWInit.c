...
/*
 *
 * FILE : MPC560xB_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC560xB derivative needed initializations, 
 *  and all initializations for the MPC560xB boards which are supported.
...
#include "MPC560xB.h"      /* MPC56xx platform development header            */
#include "MPC560xB_HWInit.h"
...
/*******************************************************/
/* MPC560xB derivative specific hardware initialization */
/*******************************************************/
...
nofralloc
    ...
    /* MPC560xB SRAM initialization code                              */
...
/*******************************************************/
/* MPC560xB boards specific hardware initializations    */
/*******************************************************/
...
#if INIT_USED_BOARD==MPC560xBDEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC560xBDEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC560xB external bus
        Set up the pins
